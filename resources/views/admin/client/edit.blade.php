                ...
                <div class="card-body">
                    ...
                    <form action="{{route('clients.update', $client)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name" value="{{$client->name}}" aria-describedby="helpId">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="dni" id="dni" value="{{$client->dni}}" aria-describedby="helpId" required>
                            @error('dni')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
